...
// iCloud Drive path — use the general iCloud Drive (com~apple~CloudDocs) which is
// accessible from both macOS (direct file path) and iOS (via nil ubiquity container).
